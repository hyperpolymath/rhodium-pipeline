...
:experimental:
:url-github: https://github.com/hyperpolymath/rhodium-pipeline
:url-gitlab: https://gitlab.com/hyperpolymath/rhodium-pipeline
:url-bitbucket: https://bitbucket.org/hyperpolymath/rhodium-pipeline
:url-codeberg: https://codeberg.org/hyperpolymath/rhodium-pipeline

Rhodium-grade CI/CD pipeline definitions
...
rhodium-pipeline is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
