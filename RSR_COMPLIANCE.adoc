= RSR Compliance: rhodium-pipeline
:toc:
:sectnums:

== Overview

This document describes the Rhodium Standard Repository (RSR) compliance status for *rhodium-pipeline*.
...
|Primary Language |Guile Scheme / Liquid (template)
|RSR Tier |Tier 2
...
|Primary language is Tier 1/2 |✓ |Guile Scheme / Liquid
...
All required items have been completed as of 2025-12-17.
